...
const youtubeAutomationPackages: Plan[] = [
    {
        ...
        price: 300,
        maxPrice: 600,
        delivery: "24-72 hours per video",
        buttonText: "Get Started",
        buttonVariant: "outline" as const,
        features: [
            ...
            { text: "3 revisions per video and thumbnail", icon: <CheckCheck size={20} /> },
        ],
        includes: [
            "Package Includes:",
            "8-12 videos/month",
            "Basic analytics report",
            "3 revisions per video & thumbnail",
        ],
    },
    {
        name: "Growth Package",
        ...
        features: [
            ...
            { text: "SEO support & content strategy", icon: <CheckCheck size={20} /> },
        ...
        includes: [
            ...
            "12-20 videos/month",
            "Custom thumbnails",
            "SEO support & content strategy",
            "Growth report",
        ],
    },
    {
        name: "Premium / Full Automation",
        description: "Includes Starter + Growth packages with 100% success score",
        price: 1800,
        maxPrice: 3000,
        delivery: "Ongoing",
        buttonText: "Get Started",
        buttonVariant: "outline" as const,
        features: [
            { text: "Everything in Starter + Growth, plus:", icon: <Rocket size={20} /> },
            ...
            { text: "100% success score guarantee", icon: <CheckCheck size={20} /> },
        ],
        includes: [
